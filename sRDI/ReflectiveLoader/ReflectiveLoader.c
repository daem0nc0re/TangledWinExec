...
ULONG_PTR ReflectiveLoader(ULONG_PTR pImageBase)
{
    NTSTATUS ntstatus;
    ...
    */
    ...
    /*
    * Step 4 : Analyze PE header for this DLL
    */
    ...
    /*
    * Step 5 : Parse this DLL's data to new memory
    */
    pModuleBuffer = 0;
    ...
    */
    ...
    /*
    * Step 9 : Set section page protection
    */
    for (DWORD index = 0; index < nSections; index++)
    {
        pSectionHeader = (PIMAGE_SECTION_HEADER)(pSectionHeadersBase + (sizeof(IMAGE_SECTION_HEADER) * index));
    ...
    */
    ...
    /*
    * Step 11 : Resolve exception handlers (x64 only)
    */
#ifdef _WIN64
